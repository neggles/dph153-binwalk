...
set trchXiSize(0)    1935
set radioEqBits(0)   0
set numCodeBlk(0)    1
set numFillerBits(0) 0
set codeBlkSize(0)   2576
set numTrBlk(0)      1
set trBlkSz(0)       2560
set eIniList(0,0)    [list 1    0 0]
set ePlusList(0,0)   [list 3870 0 0]
set eMinusList(0,0)  [list 716  0 0]
set eIniList(0,1)    [list 717  0 0]
set ePlusList(0,1)   [list 3870 0 0]
set eMinusList(0,1)  [list 716  0 0]
set eIniList(0,2)    [list 2149 0 0]
set ePlusList(0,2)   [list 3870 0 0]
set eMinusList(0,2)  [list 716  0 0]
set eIniList(0,3)    [list 2865 0 0]
set ePlusList(0,3)   [list 3870 0 0]
set eMinusList(0,3)  [list 716  0 0]
...
set eMinusList(1,0)  [list 34  0 0]
set eIniList(1,1)    [list 35  0 0]
set ePlusList(1,1)   [list 180 0 0]
set eMinusList(1,1)  [list 34  0 0]
set eIniList(1,2)    [list 103 0 0]
set ePlusList(1,2)   [list 180 0 0]
set eMinusList(1,2)  [list 34  0 0]
set eIniList(1,3)    [list 137 0 0]
set ePlusList(1,3)   [list 180 0 0]
set eMinusList(1,3)  [list 34  0 0]
