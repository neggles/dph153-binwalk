...
set isNewDataMode           1; #0 => based upon EDCH crc. 1 => always new data.
set is2MsTti                1
set firstStageSfEnum        0
set numCMTimeslotGaps       0
set actualSfEnum            1
set numCodeBlocks           2
set numBitsPerCodeBlock     2718
set numCodeBlockFillerBits  0
set numBitsInTrBlock        5412
...
set chanSelect            0x17 ; # SPECIAL CASE. mirroring the special case for 
set cfn                   0
set tDelay                1024
