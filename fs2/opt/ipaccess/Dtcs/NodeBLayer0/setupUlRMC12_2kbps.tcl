...
if { [llength $argv] < 2 } {
  puts "usage: $argv0 <hostname> <srchThreshold> <user ID (0~7)> <Use truncated 488 bits PN9 flag (1=active)>"
  exit
  ...
  set userId  [lindex $argv 2]
  set truncatedPn9 [lindex $argv 3]
}
...
writeMsg ulSymCtrl($i) [Layer0Message_UL_PHYSCH_CTRL $physChanId \
                                                 ...
                                                 $numTrch-1 ]
# TrCHId #0
set trchReset(0)     [expr ($i%2)==0 ? 1 : 0]
set ttiLog2(0)       $::PC82x9Layer0::TTIEnum(20MS)
set codingType(0)    $::PC82x9Layer0::CodingTypeEnum(CODING_CONV_1_3)
set crcType(0)       $::PC82x9Layer0::CRCTypeEnum(CRC_16BIT)
set rmType(0)        $::PC82x9Layer0::RMTypeEnum(CRC_REPETITION1)
set trchXiSize(0)    402
set radioEqBits(0)   0
set numCodeBlk(0)    1
set numFillerBits(0) 0
set codeBlkSize(0)   260
set numTrBlk(0)      1
set trBlkSz(0)       244
set eIniList(0,0)    [list 1   0 0]
set ePlusList(0,0)   [list 804 0 0]
set eMinusList(0,0)  [list 176 0 0]
set eIniList(0,1)    [list 353 0 0]
set ePlusList(0,1)   [list 804 0 0]
set eMinusList(0,1)  [list 176 0 0]
set eIniList(0,2)    [list 1   0 0]
set ePlusList(0,2)   [list 804 0 0]
set eMinusList(0,2)  [list 176 0 0]
set eIniList(0,3)    [list 353 0 0]
set ePlusList(0,3)   [list 804 0 0]
set eMinusList(0,3)  [list 176 0 0]
...
set rmType(1)        $::PC82x9Layer0::RMTypeEnum(CRC_REPETITION1)
set trchXiSize(1)    90
set radioEqBits(1)   0
set numCodeBlk(1)    1
...
set eMinusList(1,0)  [list 40  0 0]
set eIniList(1,1)    [list 81  0 0]
set ePlusList(1,1)   [list 180 0 0]
set eMinusList(1,1)  [list 40  0 0]
set eIniList(1,2)    [list 41  0 0]
set ePlusList(1,2)   [list 180 0 0]
set eMinusList(1,2)  [list 40  0 0]
set eIniList(1,3)    [list 121 0 0]
set ePlusList(1,3)   [list 180 0 0]
set eMinusList(1,3)  [list 40  0 0]
...
if {$truncatedPn9 == 1} {
  set portNumber         0x44;		# Uplink symbol rate data - Truncated PN9 mode
} else {
  set portNumber         0x40;		# Uplink symbol rate data - Normal mode
}
