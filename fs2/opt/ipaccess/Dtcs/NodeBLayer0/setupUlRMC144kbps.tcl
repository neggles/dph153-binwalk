...
set trchXiSize(0)    4350
set radioEqBits(0)   0
set numCodeBlk(0)    2
set numFillerBits(0) 0
set codeBlkSize(0)   2896
set numTrBlk(0)      2
set trBlkSz(0)       2880
set eIniList(0,0)    [list 1    0 0]
set ePlusList(0,0)   [list 8700 0 0]
set eMinusList(0,0)  [list 704  0 0]
set eIniList(0,1)    [list 4225 0 0]
set ePlusList(0,1)   [list 8700 0 0]
set eMinusList(0,1)  [list 704  0 0]
set eIniList(0,2)    [list 2113 0 0]
set ePlusList(0,2)   [list 8700 0 0]
set eMinusList(0,2)  [list 704  0 0]
set eIniList(0,3)    [list 6337 0 0]
set ePlusList(0,3)   [list 8700 0 0]
set eMinusList(0,3)  [list 704  0 0]
...
set eMinusList(1,0)  [list 16  0 0]
set eIniList(1,1)    [list 97  0 0]
set ePlusList(1,1)   [list 180 0 0]
set eMinusList(1,1)  [list 16  0 0]
set eIniList(1,2)    [list 49 0 0]
set ePlusList(1,2)   [list 180 0 0]
set eMinusList(1,2)  [list 16  0 0]
set eIniList(1,3)    [list 145 0 0]
set ePlusList(1,3)   [list 180 0 0]
set eMinusList(1,3)  [list 16  0 0]
