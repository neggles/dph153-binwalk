...
TCL_CC='arm-none-linux-gnueabi-gcc -pipe'
...
TCL_SHLIB_LD='arm-none-linux-gnueabi-gcc -pipe -shared'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/exports/md6/develop/mks/nm1/mainline2/target/application/thirdparty/expect/tcl8.4.14/unix -ltcl8.4${TCL_DBGX}'
...
# compiled.
TCL_SRC_DIR='/exports/md6/develop/mks/nm1/mainline2/target/application/thirdparty/expect/tcl8.4.14'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/exports/md6/develop/mks/nm1/mainline2/target/application/thirdparty/expect/tcl8.4.14/unix -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/exports/md6/develop/mks/nm1/mainline2/target/application/thirdparty/expect/tcl8.4.14/unix/libtclstub8.4${TCL_DBGX}.a'
